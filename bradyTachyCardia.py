...
def bradyTachyCardia(HRinst):
    ...
    :returns: (list) of same length as HRinst that indicates when brady- or
    ...
    for i, val in enumerate(HRinst):
        if val <= 60:  # this indicates bradycardia, aka the heart is beating
            #  too slowly
            bradyTachy[i] = 'B'
        elif val >= 100:  # this indicates tachycardia,
